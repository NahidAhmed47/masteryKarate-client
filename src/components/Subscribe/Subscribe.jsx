...
const Subscribe = () => {
    ...
    return (
        <div className={`rounded-md grid md:grid-cols-2 mb-10 p-5 md:p-8 lg:p-10 ${isDarkMode ? '' : 'bg-[#f6f5fb]'}`}>
            <div className='flex justify-center items-center'>
                <img src="/public/subscribe.webp" alt="subscribeImg" ></img>
            </div>
            <div className='flex items-center'>
                <div className='space-y-4'>
                    <h1 className={`text-2xl md:text-3xl  font-bold ${isDarkMode ? 'text-gray-200' : 'text-neutral'}`}>Subscribe For Our Latest Updates</h1>
