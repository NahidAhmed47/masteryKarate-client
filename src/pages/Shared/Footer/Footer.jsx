        ...
        <p className="text-white md:text-lg mt-3 md:mt-7 ">Address</p>
          ...
          <h1 className="text-xl md:text-2xl font-bold text-white">
            ...
            <div className="flex flex-col gap-3 mt-8"> 
                <Link to="/" className="text-base text-[#b8b8b8]">Home</Link>
                <Link to="/" className="text-base text-[#b8b8b8]">About Us</Link>
                <Link to="/" className="text-base text-[#b8b8b8]">Contract</Link>
                <Link to="/" className="text-base text-[#b8b8b8]">Classes</Link>
                <Link to="/" className="text-base text-[#b8b8b8]">Instructor</Link>
                <Link to="/" className="text-base text-[#b8b8b8]">Action</Link>
            </div>
          </div>
          ...
          <h1 className="text-xl md:text-2xl font-bold text-white">
            ...
            <p className="text-[#b8b8b8] text-base mt-2 md:mt-4 ">When looking at its layout. The point of using Lorem it is a long fact that will be distracted.</p>
            <input type="email" name="" id="" className="w-full rounded-full h-8 md:h-10 px-6 mt-2 md:mt-5 text-[#b8b8b8] bg-white outline-none" placeholder="Enter your email"/>
